...
%
     ...
     \begin{itemize}
        ...
        \end{quotation}
        \item The focus of this paper is the model rather than the numerical methods, so we try to leave criticism of existing numerical methods to those working to remedy the situation. That said, using nonlocal vector calculus as the basis of an FEM would seem to handle nonlocality/scale effects, but risks reintroducing mesh dependence to failure analyses.
     \end{itemize}}
%
\end{enumerate}
